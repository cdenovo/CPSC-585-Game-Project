...
HK_FORCE_INLINE void hkVector4::setInt24W( int value )
{
	...
	(reinterpret_cast<hkInt64*>(this))[3] = value |= 0x3f00000000000000ull;
#else
	(reinterpret_cast<hkInt32*>(this))[3] = value |= 0x3f000000;
#endif
}
...
{
#if defined(HK_REAL_IS_DOUBLE)
	return int ((reinterpret_cast<const hkInt64*>(this))[3] & ~0x3f00000000000000ull);
#else
...
#if defined(HK_REAL_IS_DOUBLE)
	return (reinterpret_cast<const hkUint16*>(this))[14];
#else
