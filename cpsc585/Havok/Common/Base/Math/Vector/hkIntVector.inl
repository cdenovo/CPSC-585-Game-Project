...
HK_FORCE_INLINE hkUint32 __f32_u32(hkFloat32 a)
{
	...
	if (e < 0 || (fb.u & 0x80000000)) // clip negative and fractional numbers
		return 0;
	hkUint32 r = (fb.u & 0x007FFFFF) | 0x00800000;
...
{
#if !defined(HK_PLATFORM_CTR) && !defined(HK_PLATFORM_ANDROID)  && !(defined(HK_PLATFORM_IOS) && HK_CONFIG_SIMD != HK_CONFIG_SIMD_ENABLED)
...
{
#if !defined(HK_PLATFORM_CTR) && !(defined(HK_PLATFORM_IOS) && HK_CONFIG_SIMD != HK_CONFIG_SIMD_ENABLED)
