...
class hkVector4
{
	public:
		...
		/// Returns true if the length of self is one withing the given \a epsilon bounds.
		...
		/// Load floating point values for N components from linear addresses at \a p. Not loaded components are undefined. 
		...
		/// Store floating point values of N components to linear addresses at \a p.
		/// The pointer \a p must be aligned for SIMD operations.
		...
		/// The values of self get rounded to the packed representation.
		/// The pointer \a p must be aligned for SIMD operations.
