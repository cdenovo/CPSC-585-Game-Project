...
public:
	...
	HK_FORCE_INLINE hkQTransform(hkQuaternionParameter q, hkVector4Parameter t);
	...
	HK_FORCE_INLINE void setRotation(hkQuaternionParameter q);
	...
	bool isApproximatelyEqual( const hkQTransform& other, hkReal epsilon=hkReal(1e-3f) ) const;
