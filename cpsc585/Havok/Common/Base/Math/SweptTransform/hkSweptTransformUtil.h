...
namespace hkSweptTransformUtil
{
		...
		void HK_CALL setCentreOfRotationLocal( hkVector4Parameter newCenterOfRotation, hkMotionState& sweptTrans);
		...
		void HK_CALL keyframeMotionState( const hkStepInfo& stepInfo, hkVector4Parameter pos1, hkQuaternionParameter rot1, hkMotionState& motionState );
		...
		void HK_CALL warpToPosition( hkVector4Parameter position, hkMotionState& ms );

			/// Warp the orientation of both frames to rotations. Note: This changes the m_centerOfMass
		void HK_CALL warpToRotation( hkQuaternionParameter rotation, hkMotionState& ms );

			/// Warp to position and orientation
		void HK_CALL warpTo( hkVector4Parameter position, hkQuaternionParameter rotation, hkMotionState& ms );
