...
namespace hkMathUtil
{
	...
	hkReal HK_CALL	polarDecompose(const hkMatrix3& m, hkMatrix3& u, int maxIterations = 128);

	/// Compute the affine tranformation that map the triangle S to the triangle D.
	hkBool HK_CALL	computeAffineTransformFromTriangles(	hkVector4Parameter sa, hkVector4Parameter sb, hkVector4Parameter sc,
															hkVector4Parameter da, hkVector4Parameter db, hkVector4Parameter dc,
