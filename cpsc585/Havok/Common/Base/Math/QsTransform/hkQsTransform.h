...
class hkQsTransform
{
	public:
		...
		HK_FORCE_INLINE hkQsTransform(hkVector4Parameter translation, hkQuaternionParameter rotation, hkVector4Parameter scale);

			/// Creates a new hkQsTransform using the rotation r, translation t. Sets scale to identity (1,1,1)
		HK_FORCE_INLINE hkQsTransform(hkVector4Parameter translation, hkQuaternionParameter rotation);
		...
		HK_FORCE_INLINE void set(hkVector4Parameter translation, hkQuaternionParameter rotation, hkVector4Parameter scale);

		/// Creates a new hkQsTransform using the rotation r, translation t. Sets scale to identity (1,1,1)
		HK_FORCE_INLINE void set(hkVector4Parameter translation, hkQuaternionParameter rotation);
		...
		HK_FORCE_INLINE void setScale(hkVector4Parameter s);
		...
		HK_FORCE_INLINE void setMulScaled( const hkQsTransform &t1, const hkQsTransform &t2 );
		...
		bool isApproximatelyEqual( const hkQsTransform& other, hkReal epsilon=hkReal(1e-3f) ) const;
		...
		HK_FORCE_INLINE void blendAddMul(const hkQsTransform& other, hkSimdRealParameter weight );
		HK_FORCE_INLINE void blendAddMul(const hkQsTransform& other );

		/// Weights this QsTransform by a real number for blending
		HK_FORCE_INLINE void blendWeight(hkSimdRealParameter weight );
		...
		HK_FORCE_INLINE void blendNormalize( hkSimdRealParameter totalWeight );
		HK_FORCE_INLINE void blendNormalize();

			/// Renormalizes without error checking
		HK_FORCE_INLINE void fastRenormalize( hkSimdRealParameter totalWeight );
