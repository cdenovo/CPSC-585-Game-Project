...
HK_FORCE_INLINE void hkMatrix3::_setTranspose( const hkMatrix3& s )
{
	...
	m_col2 = c2;
#else
	m_col0.set( s.getElement<0,0>(), s.getElement<0,1>(), s.getElement<0,2>(), s.getElement<0,2>() );
	m_col1.set( s.getElement<1,0>(), s.getElement<1,1>(), s.getElement<1,2>(), s.getElement<1,2>() );
	m_col2.set( s.getElement<2,0>(), s.getElement<2,1>(), s.getElement<2,2>(), s.getElement<2,2>() );
#endif
}
