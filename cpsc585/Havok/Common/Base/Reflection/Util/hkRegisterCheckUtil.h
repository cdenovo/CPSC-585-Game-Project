...
/// Utility to determine if systems registered typically by _registerSelf methods, are actual used.
...
/// 3) In any methods that indicate the system has be used place HK_USE_REGISTER_CHECK(systemName)
