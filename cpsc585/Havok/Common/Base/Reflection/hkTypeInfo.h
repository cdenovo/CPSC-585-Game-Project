...
#define HK_REFLECTION_TEMPLATE_SPECIFIER(A, B)
#define HK_REFLECTION_NOTEMPLATE_SPECIFIER(SCOPED_CPP_CLASS, TEXT_CLASS) const hkClass& HK_CALL SCOPED_CPP_CLASS::staticClass() { return TEXT_CLASS##Class; } 


#define HK_REFLECTION_DEFINE_COMMON( TEXT_CLASS, SCOPED_CPP_CLASS, FINISH, CLEANUP, VTABLE, TEMPLATE_SPECIFIER ) \
	TEMPLATE_SPECIFIER(SCOPED_CPP_CLASS, TEXT_CLASS)\
...
//
#define HK_REFLECTION_DEFINE_ABSTRACT(KLASS, KLASSNAME) \
	HK_REFLECTION_NOTEMPLATE_SPECIFIER(KLASS, KLASSNAME)
#define HK_REFLECTION_DEFINE_SCOPED_ABSTRACT(SCOPE, SCOPENAME, KLASS, KLASSNAME) \
	HK_REFLECTION_NOTEMPLATE_SPECIFIER(SCOPE::KLASS, SCOPENAME##KLASSNAME)
