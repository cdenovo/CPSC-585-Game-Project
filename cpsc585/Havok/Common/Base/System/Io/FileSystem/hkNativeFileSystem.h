...
#if defined(HK_PLATFORM_PSP) || defined(HK_PLATFORM_LINUX) || defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_IOS) || defined(HK_PLATFORM_MACPPC) || defined(HK_PLATFORM_LRB) || defined(HK_PLATFORM_NGP)
...
#	if defined (HK_PLATFORM_LINUX) ||  defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_MACPPC) || defined(HK_PLATFORM_IOS) || defined(HK_PLATFORM_LRB)
#		include <Common/Base/System/Io/Directory/Posix/hkPosixListDirectory.h>
#   elif defined (HK_PLATFORM_NGP)
#		include <Common/Base/System/Io/Directory/Ngp/hkNgpListDirectory.h>
#	else
...
#	include <Common/Base/System/Io/Reader/Android/hkAndroidAssetStreamReader.h>
#	include <Common/Base/System/Io/Writer/Posix/hkPosixStreamWriter.h>
#	include <Common/Base/System/Io/Directory/Posix/hkPosixListDirectory.h> // will only work on sdcard etc

#elif defined(HK_PLATFORM_CTR)
#	include <Common/Base/System/Io/Reader/Ctr/hkCtrStreamReader.h> // Reads from rom:

#if defined(NN_SWITCH_ENABLE_HOST_IO) 
#	include <Common/Base/System/Io/Writer/Ctr/hkCtrHioStreamWriter.h> // Writes to HostIO
#else
#	include <Common/Base/System/Io/Writer/Ctr/hkCtrStreamWriter.h> // Writes to SD Card
#endif
#	include <Common/Base/System/Io/Directory/EmptyImpl/hkListDirectoryEmptyImpl.h>
