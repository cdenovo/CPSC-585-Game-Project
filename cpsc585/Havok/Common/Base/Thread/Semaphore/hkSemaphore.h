...
#if (defined(HK_PLATFORM_MACPPC) || defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_IOS) || defined(HK_PLATFORM_LINUX) || defined(HK_PLATFORM_LRBXENSIM) ) && (HK_CONFIG_THREAD == HK_CONFIG_MULTI_THREADED)
#	include <pthread.h>
#endif
...
#if (defined(HK_PLATFORM_MACPPC) || defined(HK_PLATFORM_MAC386) || defined(HK_PLATFORM_IOS) || defined(HK_PLATFORM_LINUX) || defined(HK_PLATFORM_LRB)) && (HK_CONFIG_THREAD == HK_CONFIG_MULTI_THREADED)
