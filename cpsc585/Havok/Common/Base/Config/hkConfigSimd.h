...
// HK_SSE_VERSION
#if (defined(HK_PLATFORM_WIN32) && (HK_CONFIG_SIMD == HK_CONFIG_SIMD_ENABLED)) || defined (HK_PLATFORM_X64) || defined(HK_PLATFORM_SIM) || defined(HK_ARCH_X64) || defined(HK_PLATFORM_LINUX)
