...
#if defined( HK_PLATFORM_PS3_PPU ) ||     defined( HK_PLATFORM_GC ) ||     defined( HK_PLATFORM_RVL ) ||     defined( HK_PLATFORM_MAC386 ) || 	defined( HK_PLATFORM_MACPPC ) ||     defined( HK_PLATFORM_IOS ) ||     defined( HK_PLATFORM_CTR ) ||     defined( HK_PLATFORM_NGP ) 
