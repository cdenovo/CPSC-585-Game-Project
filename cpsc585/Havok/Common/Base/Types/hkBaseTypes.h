...
// section attribute
#if !defined(HK_PLATFORM_IOS) && !defined(HK_PLATFORM_MAC386) && !defined(HK_PLATFORM_NGP)
...
extern "C"
{
	extern HK_ALIGN16(const hkUint16) hkUFloat8_shortToReal[HK_UFLOAT8_MAX_VALUE];
}
...
#define hkUFloat8_maxValue 1000000.0f
		...
		HK_FORCE_INLINE operator float() const
		{
			return decodeFloat(hkUFloat8_shortToReal[m_value]);
		}
