...
//
#if !defined(HK_FEATURE_PRODUCT_PHYSICS) && !defined(HK_FEATURE_PRODUCT_ANIMATION) && !defined(HK_FEATURE_PRODUCT_BEHAVIOR) && !defined(HK_FEATURE_PRODUCT_CLOTH) && !defined(HK_FEATURE_PRODUCT_DESTRUCTION) && !defined(HK_FEATURE_PRODUCT_AI) && !defined(HK_FEATURE_PRODUCT_SCRIPT)
