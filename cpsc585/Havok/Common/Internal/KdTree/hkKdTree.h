...
typedef hkUint32 hkKdTreeHalfPointer;
#else
typedef hkUint16 hkKdTreeHalfPointer;
#endif
...
public:
	...
	HK_FORCE_INLINE hkBool32 isLeaf() const;

	HK_FORCE_INLINE hkBool32 isEmptyLeaf() const;
	...
	HK_FORCE_INLINE hkBool32 isLeft() const;
	
	HK_FORCE_INLINE hkBool32 isRight() const;
...
struct hkKdTreeCinfo
{
	...
	/// DEPRECATED - use hkcdDynamicTree or hkcdStaticTree instead
class hkKdTree
{
public:
