...
HK_FORCE_INLINE const hkKdTreeNode* HK_CALL hkGetNodeFromMainMemory(const hkKdTreeNode* ppuNode, hkBool unused )
{
	return ppuNode;
}
...
HK_FORCE_INLINE const hkKdTreeProjectedEntry* HK_CALL hkGetProjectedEntry(const hkKdTreeNode& spuNode, const hkKdTreeProjectedEntry* base, int primIdx)
{
