...
HK_FORCE_INLINE	hkBool32	hkcdRayDirectionAabbIntersect(const struct hkcdRay& ray, const hkAabb& aabb, hkSimdReal* HK_RESTRICT fractionInOut);

	/// Returns a bit mask corresponding to the AABBs intersecting the ray.
	/// Test result with hkVector4Comparison::MASK_X for aabb0, hkVector4Comparison::MASK_Y for aabb1 and so on.
