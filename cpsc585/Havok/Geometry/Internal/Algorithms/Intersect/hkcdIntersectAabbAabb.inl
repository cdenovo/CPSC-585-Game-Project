...
HK_FORCE_INLINE	hkBool32	hkcdIntersectAabbAabb(const hkAabb& aabbA, const hkAabb& aabbB, const hkTransform& BtoA, const hkTransform& AtoB)
{
	...
	centerA.mul(hkVector4::getConstant<HK_QUADREAL_INV_2>());	lengthA.mul(hkVector4::getConstant<HK_QUADREAL_INV_2>());	
...
// #else
	if(compB.anyIsSet(hkVector4Comparison::MASK_XYZ))
	{
		return 0;
	}
//#endif
	...
	centerB.mul(hkVector4::getConstant<HK_QUADREAL_INV_2>());	lengthB.mul(hkVector4::getConstant<HK_QUADREAL_INV_2>());
	...
	return compA.allAreSet(hkVector4Comparison::MASK_XYZ);
}
