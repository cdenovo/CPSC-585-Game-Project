...
#ifndef HK_DYNAMICS2_SIMPLE_CONSTRAINT_ATOM_H
#define HK_DYNAMICS2_SIMPLE_CONSTRAINT_ATOM_H
...
#if defined(HK_REAL_IS_DOUBLE)
	hkUint32 m_padding;		// to align the next atom on an 8 byte boundary
#endif
};
...
#endif // HK_DYNAMICS2_SIMPLE_CONSTRAINT_ATOM_H
