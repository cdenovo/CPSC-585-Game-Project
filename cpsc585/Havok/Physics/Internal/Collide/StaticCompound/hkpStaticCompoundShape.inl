...
HK_FORCE_INLINE void hkpStaticCompoundShape::Instance::setShapeSize( hkUint32 size )
{
...
HK_FORCE_INLINE hkUint32 hkpStaticCompoundShape::Instance::getShapeSize() const
{
...
HK_FORCE_INLINE void hkpStaticCompoundShape::setInstanceEnabled( int instanceId, hkBool32 isEnabled )
{
	...
	if( isEnabled )
	{
		instance.setFlags( instance.getFlags() & ~Instance::FLAG_IS_DISABLED );
	}
	else
	{
		instance.setFlags( instance.getFlags() | Instance::FLAG_IS_DISABLED );
