...
// *******************************************************
	...
	//
		...
		enum { HK_SPU_TOTAL_STATIC_COMPOUND_ELF_BUFFER_SIZE			= 56000 + HK_SPU_AGENT_SECTOR_JOB_ROOT_SHAPE_CACHE_SIZE + HK_SPU_AGENT_SECTOR_JOB_UNTYPED_CACHE_SIZE + HK_SPU_AGENT_SECTOR_JOB_MOPP_CACHE_SIZE_MIN };
	...
	//
		...
		#if !defined(HK_REAL_IS_DOUBLE) && (HK_SPU_SOLVE_SCHEMA_READER_OVERFLOW_BUFFER_SIZE < HK_SPU_SOLVE_MORE_THAN_MAX_SIZE_OF_CONTACT_SCHEMAS_WITHOUT_BUFFER_CHECK)
