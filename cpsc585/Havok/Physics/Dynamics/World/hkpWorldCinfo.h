...
class hkpWorldCinfo : public hkReferencedObject
{
	...
	public:
		...
		enum BroadPhaseType
		{
			...
			BROADPHASE_TYPE_HYBRID,
				...
				/// Sweep and prune + KD tree. This is a deprecated broad phase that existed
				/// before the tree and hybrid versions were added. It offered faster queries
				/// than SAP, but there was significant cost in rebuilding the KD tree each frame.
	...
	public:
		...
		//hkBool m_enableForceLimitBreachedSecondaryEventsFromToiSolver; //+default(false)
			...
			/// This feature is BETA; please contact support if you would like to try it.
			/// There are currently 2 SPU ELFs provided for collision detection. One supports all
			/// of the pre-2011.2 shapes. The other supports the new compound shape and compressed
			/// mesh shape added in 2011.2, but not all of the pre-2011.2 shapes.
			/// If this is true, the latter SPU ELF will be used for collision detection.
		hkBool m_BETA_useCompoundSpuElf; //+default(false)
