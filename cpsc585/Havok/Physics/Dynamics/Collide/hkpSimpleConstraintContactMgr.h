...
class hkpSimpleConstraintContactMgr: public hkpDynamicsContactMgr
{
	public:
		...
		HK_FORCE_INLINE void setRollingFrictionMultiplier(hkReal multiplier) { m_contactConstraintData.m_atom->m_info.m_rollingFrictionMultiplier = hkFloat32(multiplier); }
