...
class hkpBvTreeShape;
	...
	/// This is a utility class, which helps to export callback information from the SPU to the PPU. This is just an example how to do this.
...
HK_CLASSALIGN16(class) hkSpuCollisionCallbackUtil : public hkReferencedObject
{
	public:
		...
		static void HK_CALL HK_INIT_FUNCTION(registerSpuFunctions_StaticCompound)();
	...
	public:
		...
		static void contactPointAddedEvent_BreakOffUtilOnly(hkpEntity* entityA, hkpEntity* entityB, hkpContactPointAddedEvent&   event);
