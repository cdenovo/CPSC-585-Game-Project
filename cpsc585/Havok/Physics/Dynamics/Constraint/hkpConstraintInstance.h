...
/// An opaque piece of memory where constraints can store instance related data. It usually starts with the 
/// hkpSolverResults and can be followed by additional custom information.
