...
/// The base class for constraints, holds all information about the data of a constraint as this data is constant over 
/// the lifetime of a constraint. Defines the structure of the constraint's runtime (hkpRuntimeInfo) and provides 
/// methods to access its data (hkpConstraintRuntime). It also provides an interface to obtain the constraint atoms 
/// (hkpConstraintAtom) and their memory requirements (hkpConstraintInfo).
