...
class hkpExtendedMeshShapeBreakableMaterial : public hkpBreakableMultiMaterial
{
	...
	protected:
		...
		static HK_FORCE_INLINE const hkpExtendedMeshShape* HK_CALL getExtendedMeshShape(const hkpShape* shape);

};

#	include <Physics/Dynamics/Destruction/BreakableMaterial/MultiMaterial/ExtendedMeshShape/hkpExtendedMeshShapeBreakableMaterial.inl>
