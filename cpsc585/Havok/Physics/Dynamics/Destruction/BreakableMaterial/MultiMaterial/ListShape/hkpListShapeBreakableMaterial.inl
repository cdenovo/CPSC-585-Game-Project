...
inline const hkpListShape* HK_CALL hkpListShapeBreakableMaterial::getListShape(const hkpShape* shape)
{
	const hkpShape* retShape = shape;
	...
	HK_ASSERT2(0x623113be, retShape->getType() == HK_SHAPE_LIST, "Failed to access the hkpListShape");
