	...
	public:
		...
		struct InverseMappingDescriptor
		{
			public:
				...
				HK_DECLARE_REFLECTION();
				HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_DESTRUCTION, hkpBreakableMultiMaterial::InverseMappingDescriptor);
...
#include <Physics/Dynamics/Destruction/BreakableMaterial/MultiMaterial/hkpBreakableMultiMaterial.inl>
