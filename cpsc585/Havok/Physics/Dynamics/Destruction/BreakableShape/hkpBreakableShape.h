...
#include <Physics/Dynamics/Destruction/BreakableMaterial/hkpBreakableMaterialUtil.h>
...
class hkpBreakableShape : public hkReferencedObject
{
	...
	public:
			...
			/// Constructor
		HK_FORCE_INLINE hkpBreakableShape(const hkpShape* physicsShape = HK_NULL, hkpBreakableMaterial* material = HK_NULL)
		:	hkReferencedObject()
		...
		HK_FORCE_INLINE const hkpShape* getPhysicsShape() const { return m_physicsShape.val(); }
		...
		HK_FORCE_INLINE hkpBreakableMaterial* getMaterial() { return m_material.val(); }
			...
			/// Sets the shape.
		HK_FORCE_INLINE void setPhysicsShape(const hkpShape* newPhysicsShape) { m_physicsShape = newPhysicsShape; }
	...
	protected:
			...
			/// The physics shape
		hkRefPtr<const hkpShape> m_physicsShape;

			/// The material controlling the way the shape breaks
		hkRefPtr<hkpBreakableMaterial> m_material;
};

#include <Physics/Dynamics/Destruction/BreakableShape/hkpBreakableShape.inl>
