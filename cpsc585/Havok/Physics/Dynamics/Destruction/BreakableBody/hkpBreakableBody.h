...
#include <Physics/Dynamics/Destruction/BreakableShape/hkpBreakableShape.h>
...
class hkpBreakableBody : public hkReferencedObject
{
	...
	public:
		...
		class Controller : public hkReferencedObject
		{
			...
			protected:
				...
				hkReal m_breakingImpulse;	//+default(-1.0f)
		};
		...
		HK_FORCE_INLINE hkReal getConstraintStrength() const { return (hkReal)m_constraintStrength; }

			/// Sets the constraint strength
		HK_FORCE_INLINE void setConstraintStrength(hkReal newStrength) { m_constraintStrength = newStrength;}
	...
	protected:
		...
		hkHalf m_constraintStrength; //+default(0.0f)
};

#include <Physics/Dynamics/Destruction/BreakableBody/hkpBreakableBody.inl>
