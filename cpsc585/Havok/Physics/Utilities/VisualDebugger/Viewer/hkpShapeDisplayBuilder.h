...
class hkpShapeDisplayBuilder: public hkDisplayGeometryBuilder
{
	...
	public:
			/// Creates an array of display geometries from a given shape and a transform including scale
		void buildShapeDisplay(	const hkpShape* shape, const hkQsTransform& transform, hkArray<hkDisplayGeometry*>& displayGeometries );
	...
	public:
		...
		void buildShapeDisplay_ConvexVertices( const hkpConvexVerticesShape* shape, const hkQsTransform& transform, hkArray<hkDisplayGeometry*>& displayGeometries );
        void buildShapeDisplay_StaticCompound( const hkpStaticCompoundShape* staticCompoundShape, const hkTransform& transform, hkArray<hkDisplayGeometry*>& displayGeometries );
		...
		void buildShapeDisplay_BvCompressedMeshShape( const hkpBvCompressedMeshShape* bvCompressedMeshShape, const hkQsTransform& transform, hkArray<hkDisplayGeometry*>& displayGeometries );
