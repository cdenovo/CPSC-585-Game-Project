...
struct hkpSurfaceInfo
{
	...
	{		
		return ((m_supportedState == UNSUPPORTED) || (m_surfaceNormal.isOk3() && m_surfaceNormal.isNormalized3() && 
				m_surfaceVelocity.isOk3() && hkMath::isFinite(m_surfaceDistanceExcess)));
	}
};
