...
#	define HK_AGENT3_MIDPHASE_AGENT_SIZE 0x50
#	define HK_AGENT3_NARROWPHASE_AGENT_SIZE 0xa0
#	define HK_AGENT3_MAX_AGENT_SIZE 0xa0
#	define HK_AGENT3_SECTOR_SIZE (0xa0*4)
#elif ( HK_POINTER_SIZE == 4 ) 
