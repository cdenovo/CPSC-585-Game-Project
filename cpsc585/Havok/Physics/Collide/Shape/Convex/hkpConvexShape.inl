...
void hkpConvexShape::getSupportingVertex( hkVector4Parameter direction, hkcdVertex& supportingVertexOut ) const
{
	this->getSupportingVertexImpl( direction, supportingVertexOut );
}

void hkpConvexShape::convertVertexIdsToVertices( const hkpVertexId* ids, int numIds, hkcdVertex* vertixArrayOut) const
{
