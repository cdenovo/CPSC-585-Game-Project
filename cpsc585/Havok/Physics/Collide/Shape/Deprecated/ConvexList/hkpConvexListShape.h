...
class hkpConvexListShape : public hkpConvexShape, public hkpShapeContainer
{
	...
	HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_BASE);
		...
		void getSupportingVertexImpl( hkVector4Parameter dir, hkcdVertex& supportingVertexOut ) const;

			// Implemented method of hkpConvexShape
		void convertVertexIdsToVerticesImpl( const hkpVertexId* ids, int numIds, hkcdVertex* verticesOut) const;
