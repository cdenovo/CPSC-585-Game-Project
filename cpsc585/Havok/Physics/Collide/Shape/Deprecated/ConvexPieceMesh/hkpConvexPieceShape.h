...
class hkpConvexPieceShape : public hkpConvexShape, protected hkpShapeContainer
{
	...
	HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_BASE);
		...
		virtual void getSupportingVertexImpl( hkVector4Parameter direction, hkcdVertex& supportingVertex ) const;

			// hkpConvexShape interface implementation.
		virtual void convertVertexIdsToVerticesImpl( const hkpVertexId* ids, int numIds, hkcdVertex* verticesOut) const;
