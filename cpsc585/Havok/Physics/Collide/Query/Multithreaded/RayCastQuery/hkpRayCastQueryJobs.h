...
public:
	...
	HK_FORCE_INLINE hkpWorldRayCastWithAutoBundleJob() : hkpRayCastQueryJob(RAYCAST_QUERY_WORLD_RAYCAST_WITH_AUTOBUNDLE, sizeof(hkpWorldRayCastWithAutoBundleJob) ){ }
