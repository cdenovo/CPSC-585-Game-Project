...
class hkKdTreeRayCastJobUtil
{
	public:
		...
		static void HK_CALL makeBundleFromInputs(hkpWorldRayCastInput* inputs, hkFourTransposedPoints& fromBundle, hkFourTransposedPoints& toBundle);
...
class hkTreeRayCastJobUtil
{
	public:
		...
		static void HK_CALL castRayByCommands(
		...
		static void HK_CALL castRayBundleByCommands(
